"""
Primordial Garden v0.2.0 - Enhanced Mode
        ...
        if name.lower() == 'done':
            ...
            if choice == '1':
                ...
                traits = SpeciesTraits(base_energy=120, energy_decay=3, photosynthesis_rate=3,
                                     can_move=True, movement_cost=5, color=(0, 200, 255))
                name = "Mobile"
            else:
...
def main():
    ...
    print("=" * 60)
    print("PRIMORDIAL GARDEN v0.2.0 - ENHANCED MODE")
    print("=" * 60)
    print("\nNew Features:")
    print("  • Energy system")
    print("  • Environmental zones")
    print("  • Cell mobility")
    ...
    print("Controls: SPACE=pause, 1-5=speed, S=export, R=reset, Q=quit")
    print("=" * 60 + "\n")
        ...
        if not paused:
            for _ in range(speed):
                ...
                if grid.generation % 10 == 0:
                    export_data.append(grid.get_stats())
